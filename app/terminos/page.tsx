...
const sections = [
  ...
  },
  {
    ...
    body: [
      "Los productos, formatos, precios, planes, costos de despacho y disponibilidad pueden variar según stock, comuna, fechas de entrega, volumen solicitado y confirmación previa. La información publicada en el sitio es referencial hasta que FEROX confirme el pedido por un canal oficial.",
      "FEROX puede actualizar productos, precios, beneficios de planes, costos de despacho o disponibilidad sin aviso previo, procurando mantener la información comercial clara y actualizada.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "El cliente debe revisar que el monto pagado coincida con el pedido confirmado, incluyendo productos, planes, beneficios asociados y despacho cuando corresponda.",
    ],
  },
  {
