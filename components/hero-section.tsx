...
export function HeroSection() {
  return (
    <section className="relative h-[100svh] min-h-[100svh] overflow-hidden bg-background">
      ...
      <div className="relative z-10 mx-auto flex h-full w-full max-w-7xl items-start md:items-center px-4 sm:px-6 lg:px-8 pt-28 pb-24 md:pt-32 md:pb-16">
        <div className="max-w-lg translate-y-2 md:-translate-y-2 text-center md:text-left flex flex-col items-center md:items-start">
          ...
          <p className={`${heroInter.className} mt-7 md:mt-5 text-base sm:text-lg md:text-xl text-white/85 leading-relaxed text-pretty max-w-lg mx-auto md:mx-0`}>
          ...
          <div className={`${heroInter.className} mt-14 md:mt-9 flex flex-wrap items-center justify-center md:justify-start gap-2`}>
