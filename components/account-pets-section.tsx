    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col justify-center px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        ...
        <div className="mt-10 grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-6">
          <article className="rounded-2xl border border-border bg-background p-5 sm:p-6 lg:p-8">
            ...
            <button className="mt-5 inline-flex rounded-full bg-foreground px-4 py-2.5 sm:px-5 sm:py-3 text-sm font-medium text-background hover:bg-foreground/90">
              Crear cuenta
            </button>
          </article>
          ...
          <article className="rounded-2xl border border-border bg-background p-5 sm:p-6 lg:p-8">
            ...
            <button className="mt-5 inline-flex rounded-full border border-foreground px-4 py-2.5 sm:px-5 sm:py-3 text-sm font-medium text-foreground hover:bg-muted">
              Añadir perro
            </button>
          </article>
        </div>
