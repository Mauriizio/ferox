    ...
    <section className="relative overflow-hidden bg-foreground text-background border-t border-border">
      ...
      <div className="fade-up relative z-10 mx-auto flex min-h-[72svh] w-full max-w-4xl flex-col justify-center px-4 py-20 text-center sm:px-6 sm:py-24 lg:px-8 lg:py-28">
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center items-stretch sm:items-center">
          <Link
            href="#calculadora"
            className="interactive-lift premium-transition inline-flex items-center justify-center gap-2 rounded-full bg-background px-6 py-4 text-sm font-medium text-foreground hover:bg-background/90 sm:text-base"
          >
          ...
          <a
            ...
            className="interactive-lift premium-transition inline-flex items-center justify-center gap-2 rounded-full border border-background/30 px-6 py-4 text-sm font-medium text-background hover:bg-background/10 sm:text-base"
          >
