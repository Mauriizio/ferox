  ...
  return (
    <section id="comunidad" className="border-t border-border bg-background">
      <div className="mx-auto w-full max-w-3xl px-4 py-14 sm:px-6 sm:py-16 lg:py-20">
        <article data-reveal className="soft-card-hover premium-transition rounded-3xl border border-border bg-muted/25 p-4 shadow-sm sm:p-6">
          ...
          <header data-reveal className="fade-up mt-4 text-center">
          ...
          <ol className="relative mt-6 space-y-3">
            ...
            {timelineItems.map((item) => (
              <li key={item.step} className="relative flex items-center gap-3">
                ...
                <article data-reveal className="soft-card-hover premium-transition flex w-full items-center gap-3 rounded-2xl border border-border bg-background/90 p-2.5 shadow-sm">
