...
const complements = [
  ...
  },
  {
    ...
    detail: "Omega 3 o un toque de aceite de oliva para apoyar piel y pelaje.",
  },
  {
    icon: Wheat,
    title: "Avena opcional",
    detail: "Puede agregarse si le cae bien y buscas más saciedad.",
  },
  {
    icon: Leaf,
    title: "Extras naturales",
    detail: "Complementos simples, introducidos poco a poco.",
  },
];
...
export function WhatIsBarf() {
  return (
    <section
      id="que-es-barf"
      className="bg-background border-t border-border/70"
    >
      <div className="mx-auto flex w-full max-w-7xl items-center px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-14 items-center w-full">
          ...
          <div data-reveal className="fade-up text-center lg:py-2 lg:text-left">
            ...
            <div className="mx-auto mt-4 max-w-2xl space-y-3 text-base leading-relaxed text-muted-foreground sm:text-lg lg:mx-0">
              <p>
                ...
                natural basada en alimentos reales como carne, huesos carnosos y
                órganos, diseñada para respetar la biología de tu perro.
              </p>
              <p>
                A diferencia del pellet, el BARF{" "}
                <strong className="text-foreground">
                  no contiene químicos, conservantes ni subproductos.
                </strong>
              </p>
            </div>
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-4">
              {composition.map((item) => (
                <div
                  key={item.label}
                  data-reveal className="soft-card-hover premium-transition border border-border rounded-xl p-4 text-center glass shadow-sm sm:p-5"
                >
            ...
            <div data-reveal className="soft-card-hover premium-transition mt-8 grid gap-4 rounded-2xl border border-border bg-muted/35 p-4 sm:p-5">
              <div>
                <h3 className="text-xl font-bold text-foreground sm:text-2xl">
                  Ingredientes que lleva nuestro BARF
                </h3>
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground sm:text-base">
                  Una mezcla balanceada con ingredientes reales para entregar
                  nutrición completa, fresca y funcional.
                </p>
              </div>
            ...
            <div data-reveal className="soft-card-hover premium-transition mt-4 rounded-2xl border border-foreground/10 bg-foreground p-4 text-background sm:p-5">
              ...
              <p className="mt-2 text-sm leading-relaxed text-background/70 sm:text-base">
                ...
                naturales para variar y complementar. Hazlo de forma gradual y
                consulta si tu perro tiene una condición especial.
              </p>
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {complements.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className="rounded-xl bg-background/10 p-3"
                    >
